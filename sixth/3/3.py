...
# оптимизируем
dataset = read_file(os.path.join(res_file, os.path.normpath('df_3.csv')))
...
with open(os.path.join(res_file, os.path.normpath("dtypes_3.json")), mode='w') as file:
...
#     print(part.shape)
#     part.dropna().to_csv(os.path.join(res_file, os.path.normpath('df_3.csv')), mode='a', header=has_header)
#     print(part.shape)
#     has_header = False
# print(total_size)

...
my_file = os.path.join(os.path.dirname(__file__), os.path.normpath('archive.zip'))
...
#     print(part.shape)
#     part.dropna().to_csv(os.path.join(res_file, os.path.normpath('df_6.csv')), mode='a', header=has_header)
#     print(part.shape)
#     has_header = False
# print(total_size)

# оптимизируем
# dataset = read_file(os.path.join(res_file, os.path.normpath('df_6.csv')))
...
# with open(os.path.join(res_file, os.path.normpath("dtypes_6.json")), mode='w') as file:

...
my_file = os.path.join(os.path.dirname(__file__), os.path.normpath('[5]asteroid'), os.path.normpath('dataset.csv'))
...
# оптимизируем
dataset = read_file(os.path.join(res_file, os.path.normpath('df_5.csv')))
...
with open(os.path.join(res_file, os.path.normpath("dtypes_5.json")), mode='w') as file:
...
#     print(part.shape)
#     # part.dropna().to_csv(os.path.join(res_file, os.path.normpath('df_5.csv')), mode='a', header=has_header)
#     part.to_csv(os.path.join(res_file, os.path.normpath('df_5.csv')), mode='a', header=has_header)
#     print(part.shape)
#     has_header = False
# print(total_size)
